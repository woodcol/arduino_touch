...
def func_getSerial():
    ...
    #try:
        if os.path.exists('config.json'):
            ...
            f.close()
            print(dictmp)
            print(dictmp['port'].encode('gb18030'),dictmp['btv'])
            return dictmp['port'].encode('gb18030'),dictmp['btv']
...
class STool(object):
    ...
    def __init__(self):
        ...
        if self.dev and self.pbtv:
           # try:
            self.t = serial.Serial('com3',115200,timeout=0.5)
           # except Exception as e:
